...
export default function DiscoverSearch({
  ...
  const filteredProfiles = useMemo(() => {
    ...
    return profiles.filter((profile) => {
      ...
      return usernameMatch || bioMatch || skillMatch;
    });
  }, [profiles, query]);
  ...
  return (
    <>
      ...
      <div className="mb-12">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.05] backdrop-blur-2xl shadow-[0_0_40px_rgba(168,85,247,0.08)]">
          ...
          <div className="relative px-6 py-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                placeholder="Search usernames, bios, or skills..."
      ...
      {/* EMPTY DATABASE */}
      {profiles.length === 0 && (
        <div className="rounded-3xl border border-dashed border-white/10 bg-white/[0.03] backdrop-blur-xl p-14 text-center">
          ...
          <p className="text-zinc-400 max-w-xl mx-auto leading-relaxed">
            SkillProof is just getting started. Be one of the first creators,
            developers, freelancers, or professionals to build a verified
            public profile.
          </p>
          ...
          <div className="mt-8">
            <Link
              href="/signup"
              className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-purple-600 to-fuchsia-600 px-6 py-4 font-semibold text-white hover:opacity-90 transition shadow-lg shadow-purple-900/30"
            >
              Create Your Profile →
            </Link>
          </div>
      ...
      {profiles.length > 0 && filteredProfiles.length === 0 && (
        <div className="mt-12 rounded-3xl border border-white/10 bg-white/[0.04] backdrop-blur-xl p-12 text-center">
          ...
          <p className="text-zinc-400">
            Try searching with a different username or skill.
          </p>
